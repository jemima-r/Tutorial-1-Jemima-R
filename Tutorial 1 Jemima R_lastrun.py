...
expName = 'Tutorial 1 Jemima R'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\JEMIMA\\Desktop\\lab in psychology\\Tutorial 1 Jemima R_lastrun.py',
...
if random()>0.5: # 50:50 probablity
    location = (-0.2,0)
    corrAns = 'left'
else:
    location = (0.2, 0)
...
conditions = data.importConditions('C:/Users/JEMIMA/Documents/Conditions tutorial 1 Jemima R.xlsx')
